...
enum {
    ...
    STR_ALARM_SNOOZE,
    STR_ALARM_REPEAT,
    STR_ALARM_REPEAT_ONCE,
    STR_ALARM_REPEAT_DAILY,
    STR_ALARM_REPEAT_WEEKDAYS,
    STR_ALARM_SNOOZE_TOAST,

    /* Weather — app / current / forecast / city */
    STR_APP_WEATHER,
    STR_WEATHER_CITY,
    STR_WEATHER_REFRESH,
    ...
    STR_WEATHER_AUTO_LOCATE,
    STR_WEATHER_MANUAL,
    STR_WEATHER_SEARCH,
    STR_WEATHER_SEARCH_HINT,
    STR_WEATHER_LOADING,
    STR_WEATHER_LOAD_FAILED,
    STR_WEATHER_LOCATE_FAILED,
    STR_WEATHER_NO_NETWORK,
    STR_WEATHER_NO_RESULTS,
    STR_WEATHER_UPDATED,
    STR_WEATHER_CLEAR,
    ...
    /* Weather — specific failure reasons */
    STR_WEATHER_ERR_CONNECT,
    STR_WEATHER_ERR_TLS,
    STR_WEATHER_ERR_TIMEOUT,
    STR_WEATHER_ERR_SERVER,
