...
static void on_card_clicked(lv_event_t* e) {
     ...
     * as SHORT_CLICKED; gesture_dir disambiguates a flick in any direction
     * (incl. left-swipe-to-delete), and press_moved catches any meaningful
     * pointer movement during the press that never became a recognized gesture. */
